...
var color = ['#ff5252', '#ff4081', '#e040fb', '#7c4dff', '#53dff', '#40cdff', '#18ffff', '#64ffda', '#69f0ae', '#b2ff59'];
...
function newShell() {
    ...
    shell.color = color[Math.floor(Math.random() * color.length)];
...
function Run() {
    ...
    for (let pas of pass) {
        ...
        if (pas.y > cheight || pas.y < -50 || pas.size <= 0) {
            pass.splice(pass.indexOf(pas), 1);
        }
    }
